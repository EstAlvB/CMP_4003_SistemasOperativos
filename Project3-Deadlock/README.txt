...
- Jorge Esteban Alvarado Borja (00215138) : 
...
- Alexander Gabriel Pástor Villacís (00211253) : 
    Encargado de:
    
	Implementación de componentes para el ingreso de datos para la prueba, en la función
	getMatrixByInput().

	Implementación de la sección main, en la cual se ejecutan las funciones del algoritmo.
